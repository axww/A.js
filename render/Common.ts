        ...
        <div class="flex-none hidden lg:block">
          <ul class="menu menu-horizontal gap-2 items-center">
            ...
            ${z.i ? html`
              ...
              <li><a href="/m" class="btn btn-sm ${(z.i.last_message > z.i.last_read) ? 'btn-error' : 'btn-ghost'} gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <footer class="footer footer-center p-4 bg-base-100 text-base-content border-t">
      <div class="flex flex-col items-center gap-2">
        ...
        <p class="text-sm opacity-50">
          <a href="https://github.com/axww/A.js" target="_blank">GitHub</a>
      ...
      <div class="menu p-4 w-80 min-h-full bg-base-100">
        ...
        <ul class="menu menu-lg gap-2">
          ${z.i ? html`
            ...
            <li>
              <a href="/m" class="gap-4 ${(z.i.last_message > z.i.last_read) ? 'text-error' : ''}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                </svg>
                通知
