...
<div class="container mx-auto max-w-5xl lg:px-0">
    <div class="flex flex-col gap-4">
        ${z.data.map(async item => html`
            <div id="time-${item.date_time}" class="card bg-base-100 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm pt-2 text-base-content/70">
                        <div class="flex items-center gap-2 min-w-0">
                            ...
                            <a href="/?user=${item.user}&land=${z.data[0].root_land}" target="_blank" class="link link-hover truncate max-w-[120px] role_${item.grade}">${item.name}</a>
                        </div>
                        ...
                        ${(z.i) ? html`
                            ...
                            <div class="flex flex-wrap gap-1">
                                ${(z.i.grade >= 2 && item.root_land > 0) ? html`
